                        ...
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">{{ $departement->id }}</h6>
                            </div>
                          </div>
                        </td>
                        <td>
                          <p class="text-xs font-weight-bold mb-0">{{ $departement->code }}</p>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <p class="text-xs font-weight-bold mb-0">{{ $departement->departement }}</p>
                        </td>
                        <td>
                          <form action="{{ route('departement.destroy',$departement->id) }}" method="POST">
                            <a class="btn btn-info" href="{{ route('departement.show',$departement->id) }}"><i class="fa fa-info"></i></a>
